	...
	return (
		<article className="prose mt-8 pb-16 dark:prose-invert">
			...
			<div className="space-y-4">
				...
				<p>
					This is just a static portfolio site, so I don&apos;t
				...
				<p>
					...
					be pragmatic, no system is foolproof. While I&apos;ll take reasonable steps
				...
				<p>
					...
					an email at{" "}
					<Link href="mailto:samuelikohn@gmail.com">samuelikohn@gmail.com</Link> or use
